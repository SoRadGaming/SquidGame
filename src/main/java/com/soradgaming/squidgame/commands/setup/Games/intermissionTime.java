...
public class intermissionTime implements CommandHandlerInterface {
    private SquidGame plugin;

    public intermissionTime(SquidGame plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean handleCommand(Player player, String[] args) {
        ...
        if (!args[1].equalsIgnoreCase("intermissionTime")) {
            return true;
        }
        arena.getStructureManager().setIntermissionTime(Integer.parseInt(args[2]));
        return true;
    }
