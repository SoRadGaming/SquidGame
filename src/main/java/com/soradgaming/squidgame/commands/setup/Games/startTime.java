...
public class startTime implements CommandHandlerInterface {
    private SquidGame plugin;

    public startTime(SquidGame plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean handleCommand(Player player, String[] args) {
        ...
        if (!args[1].equalsIgnoreCase("startTime")) {
            return true;
        }
        arena.getStructureManager().setStartTime(Integer.parseInt(args[2]));
        return true;
    }
